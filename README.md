...
An all-in-one sampling node (**UIT Sampler**) for [HiDream-O1-Image](https://github.com/HiDream-ai/HiDream-I1) by easygoing0114.
...
| `clip` | CLIP | optional | CLIP / text encoder (stub connection for HiDream-O1) |
| `vae` | VAE | optional | VAE (stub connection for HiDream-O1) |
